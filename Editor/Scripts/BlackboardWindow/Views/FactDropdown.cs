...
public class FactDropdown : VisualElement
{
    ...
    {
        if(filterByFactType)
            return BlackboardManager.instance.FactDataBase.GetPairs(factType);
        else
            return BlackboardManager.instance.FactDataBase.GetPairs();
    }
    ...
    private void UpdateButtonText()
    {
        ...
        if (factSelected != null)
            factPath = BlackboardManager.instance.GetFactPath(factSelected.groupId, factSelected.id);

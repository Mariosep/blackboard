...
public class EventsSimulatorListView : VisualElement
{
    ...
    private VisualElement MakeTypeCell()
    {
        ...
        enumField.pickingMode = PickingMode.Ignore;
    ...
    private void BindArgument(VisualElement cell, int i)
    {
        ...
        /*ObjectField objectField = cell.Q<ObjectField>();

        switch (_events[i].type)
        {
            case BlackboardEventType.Actor:
                objectField.objectType = typeof(ActorSO);
                break;
        ...
        objectField.RegisterValueChangedCallback(e => _arguments[i] = (ScriptableObject) e.newValue);*/
    }

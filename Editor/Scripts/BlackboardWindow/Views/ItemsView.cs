...
public class ItemsView : VisualElement
{
    ...
    private void AddItem()
    {
        ...
        ScriptableObjectUtility.SaveSubAsset(newItem, BlackboardManager.instance.Blackboard);
    ...
    private void OnRemoveItemButtonClicked()
    {
        ...
        {
            ShowConfirmActorDeletionPopUp(itemsSelected);
        }
    }

    private void ShowConfirmActorDeletionPopUp(params ItemSO[] items)
    {

...
namespace Blackboard.Editor.Items
{
    public class ItemDropdown : VisualElement
    {
        ...
        {
            return BlackboardEditorManager.instance.ItemDataBase.GetPairs();
        }
        ...
        private void UpdateButtonText()
        {
            ...
            if (itemSelected != null)
                itemPath = BlackboardEditorManager.instance.GetItemPath(itemSelected.group.id, itemSelected.id);

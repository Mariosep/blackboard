...
public class EventsEditorView : VisualElement
{
    ...
    {
        EventSO newEvent = BlackboardElementFactory.CreateEvent(EventType.Actor);
        ScriptableObjectUtility.SaveSubAsset(newEvent, BlackboardEditorManager.instance.Blackboard);
    ...
    private void OnEventTypeChanged(int i, EventType newType)
    {

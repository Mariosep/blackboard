...
namespace Blackboard.Editor
{
    public class BlackboardElementSearchProvider : ScriptableObject, ISearchWindowProvider
    {
        ...
        private List<KeyValuePair<Type, string>> eventItems;
        ...
        public void Init(Action<BlackboardElementSO> callback,
            ...
            List<KeyValuePair<Type, string>> eventItems = null,
        ...
        public List<SearchTreeEntry> CreateSearchTree(SearchWindowContext context)
        {
            ...
            if (eventItems != null)
            {
                ...
                List<KeyValuePair<Type, string>> sortedItems = eventItems;
                sortedItems.Sort((a, b) =>
                {
                    string[] splitsA = a.Value.Split('/');
                    string[] splitsB = b.Value.Split('/');
        ...
        {
            // Case of Event type selected 
            if (SearchTreeEntry.userData is Type type)
            {
                var eventData = (BaseEventSO) CreateInstance(type);
                eventData.Init(GUID.Generate().ToString());
                SearchTreeEntry.userData = eventData;
            }
